...
class LayoutReloj extends StatefulWidget {
  @override
  _LayoutRelojState createState() => _LayoutRelojState();
}

class _LayoutRelojState extends State<LayoutReloj> {
  ...
  Widget build(BuildContext context) {
    ...
    if (DatosEstaticos.widget1 != null) {
      ...
      Widget _imageSeleccionLayout = Image.asset(
